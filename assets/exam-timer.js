(function () {
  ...
  var STORAGE_KEY = 'jenkins_exam_progress';
  var CHAPTER_STORAGE_KEY = 'jenkins_chapter_progress';
  ...
  var CHAPTERS = [
    { id: '01-introduction-to-ci-cd-and-jenkins',           title: 'Ch 1: Introduction to CI/CD & Jenkins',          number: 1,  section: 'Foundation' },
    { id: '02-jenkins-architecture-and-installation',       title: 'Ch 2: Jenkins Architecture & Installation',     number: 2,  section: 'Foundation' },
    { id: '03-jenkins-configuration-and-management',        title: 'Ch 3: Configuration & Management',              number: 3,  section: 'Foundation' },
    { id: '04-freestyle-projects-and-build-jobs',           title: 'Ch 4: Freestyle Projects & Build Jobs',         number: 4,  section: 'Foundation' },
    { id: '05-pipeline-fundamentals',                       title: 'Ch 5: Pipeline Fundamentals',                   number: 5,  section: 'Core Skills' },
    { id: '06-pipeline-syntax-and-steps',                   title: 'Ch 6: Pipeline Syntax & Steps',                 number: 6,  section: 'Core Skills' },
    { id: '07-agents-nodes-and-distributed-builds',         title: 'Ch 7: Agents, Nodes & Distributed Builds',      number: 7,  section: 'Core Skills' },
    { id: '08-source-code-management',                      title: 'Ch 8: Source Code Management',                  number: 8,  section: 'Core Skills' },
    { id: '09-shared-libraries-and-reusability',            title: 'Ch 9: Shared Libraries & Reusability',           number: 9,  section: 'Advanced' },
    { id: '10-multi-branch-pipelines',                      title: 'Ch 10: Multi-Branch Pipelines',                 number: 10, section: 'Advanced' },
    { id: '11-jenkins-docker-and-kubernetes',               title: 'Ch 11: Docker & Kubernetes Integration',        number: 11, section: 'Advanced' },
    { id: '12-testing-security-and-compliance',             title: 'Ch 12: Testing, Security & Compliance',         number: 12, section: 'Advanced' },
    { id: '13-jenkins-configuration-as-code',               title: 'Ch 13: Jenkins Configuration as Code (JCasC)',  number: 13, section: 'Production & Exam Prep' },
    { id: '14-production-grade-jenkins',                    title: 'Ch 14: Production-Grade Jenkins',               number: 14, section: 'Production & Exam Prep' },
    { id: '15-exam-preparation-guide',                      title: 'Ch 15: Exam Preparation Guide',                 number: 15, section: 'Production & Exam Prep' },
  ...
  function buildDashboardHTML() {
    ...
    html += '  <p class="exam-progress-summary">Track your Jenkins learning journey — from chapters to practice exams</p>';
    html += '</div>';
    ...
    TESTS.forEach(function (t) {
      ...
      html += '    <p>57 questions across all domains | 60 min</p>';
